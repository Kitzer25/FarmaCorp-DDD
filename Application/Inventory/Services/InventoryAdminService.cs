...
public class InventoryAdminService : IInventoryAdminService
{
    ...
    public async Task<InventoryItemDto> RegisterMovementAsync(int? userId, CreateInventoryMovementDto request, CancellationToken ct)
    {
    ...
    private static InventoryItemDto ToDto(Core.Entities.Inventory inventory)
    {
